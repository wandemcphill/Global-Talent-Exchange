...
#pragma warning restore 0109
        ...
        public void SetExternalPlaybackPose(Vector3 position, Quaternion rotation, bool snap = false)
        {
            ...
            externalPlaybackTargetPosition = position; externalPlaybackTargetRotation = rotation; hasExternalPlaybackPose = true;
            if (!externalPlaybackEnabled || rigidbody == null) { SetInstantPosition(position); SetInstantRotation(rotation); return; }
            GtexPlaybackPhysicsUtil.ApplyExternalPlaybackPosition(transform, rigidbody, position, rotation, snap); lastKnownPosition = transform.position;
        }
