...
#pragma warning restore 0109
        ...
        private void FixedUpdate()
        {
            ...
            // producing overspeed movement, foot sliding and apparent teleports.
        ...
        private (float turnResult, float angleDifferency) AgileToDirection(Vector3 targetDirection)
        {
            ...
            var agility = BasePlayer != null && BasePlayer.MatchPlayer != null
                ? Mathf.Max(0.25f, BasePlayer.MatchPlayer.GetAgility())
                : 4f;
            var settings = EngineSettings.Current;
            var moveHardness = settings != null && settings.AgileToDirectionMoveSpeedHardness != null
                ? settings.AgileToDirectionMoveSpeedHardness.Evaluate(MoveSpeed)
                : Mathf.Lerp(0.8f, 1.8f, Mathf.Clamp01(MoveSpeed / 6f));
            var angleHardness = settings != null && settings.AgileToDirectionAngleDifferencyHardness != null
        ...
        public bool MoveTo(in float deltaTime, Vector3 targetPosition, bool faceTowards = true, MovementType movementType = MovementType.BestHeCanDo)
        {
            ...
            if (distance > reachRadius)
            {
                ...
                if (movementType == MovementType.Relax)
        ...
        public bool LookTo(in float deltaTime, Vector3 lookDirection)
        {
            ...
            var holdingBallModifier = BasePlayer != null && BasePlayer.IsHoldingBall
            ...
            if (BasePlayer != null && BasePlayer.IsHoldingBall && !BasePlayer.IsThrowHolder && Ball.Current != null)
        ...
        public void ProcessMovement(in float time, in float deltaTime)
        {
            ...
            var acceleration = finalSpeed < MoveSpeed
                ? 3f
                : (BasePlayer != null && BasePlayer.MatchPlayer != null ? BasePlayer.MatchPlayer.GetAcceleration() : 6f);
        ...
        public void Up(in float dT, MatchStatus matchStatus, Ball ball)
        {
            ...
            if (BasePlayer.ActiveBehaviour is ChipShootingBehaviour || BasePlayer.ActiveBehaviour is ShootingBehaviour || BasePlayer.ActiveBehaviour is PassingBehaviour || BasePlayer.ActiveBehaviour is CrossingBehaviour)
