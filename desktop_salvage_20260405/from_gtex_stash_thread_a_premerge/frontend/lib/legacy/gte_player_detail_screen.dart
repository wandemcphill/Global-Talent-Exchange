              ...
              return AnimatedBuilder(
                ...
                builder: (BuildContext context, Widget? child) {
                  final PlayerProfile? profile =
                      widget.controller.selectedProfile;
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                GtePlayerActionRow(
                  ...
                  onTransferRoom: () =>
                      controller.toggleTransferRoom(player.id),
                  onIntensity: () =>
                      controller.cycleNotificationIntensity(player.id),
                ),
              ],
            ),
          ),
              ...
              final Widget intelligence = GteSurfacePanel(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(profile.scoutingReport,
                        style: Theme.of(context).textTheme.bodyLarge),
                    const SizedBox(height: 18),
                    Text('Transfer signal',
                        style: Theme.of(context).textTheme.titleLarge),
                    const SizedBox(height: 10),
                    Text(profile.transferSignal,
                        style: Theme.of(context).textTheme.bodyLarge),
                  ],
                ),
              );
