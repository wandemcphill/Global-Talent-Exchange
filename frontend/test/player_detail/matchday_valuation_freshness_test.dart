  ...
  group('MatchdayFormCard valuation timing', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          find.textContaining('published valuation does not'),
          findsOneWidget,
        );
    ...
    testWidgets('a caught-up valuation says so rather than staying silent', (
      ...
      expect(find.textContaining('2026-09-02 04:00:00'), findsOneWidget);
    });
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        await _pump(
          ...
          MatchdayFormCard(
            form: _form(),
            freshness: const GtexValuationFreshnessReport(
