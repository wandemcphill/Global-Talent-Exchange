  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final ClubSaleListingCollection collection =
          ClubSaleListingCollection.fromJson(<String, Object?>{
            'total': 1,
      ...
      final ClubSaleMarketController controller = ClubSaleMarketController(
        repository: _FakeClubSaleMarketRepository(collection: collection),
      );
...
class _FakeClubSaleMarketRepository implements ClubSaleMarketRepository {
  _FakeClubSaleMarketRepository({required this.collection});
