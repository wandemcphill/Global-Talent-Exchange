...
class ClubSaleMarketController extends ChangeNotifier {
  ClubSaleMarketController({required ClubSaleMarketRepository repository})
  ...
  factory ClubSaleMarketController.standard({
    ...
    return ClubSaleMarketController(
      repository: createClubSaleMarketRepository(
        baseUrl: baseUrl,
  ...
  Future<void> loadPublicListings({
    ...
    try {
      final ClubSaleListingCollection collection = await _repository
  ...
  Future<void> loadHistory(
    ...
    try {
      final ClubSaleHistory nextHistory = await _repository.fetchHistory(
        clubId,
        query,
      );
