...
class ClubSaleListingsQuery {
  const ClubSaleListingsQuery({this.limit = 50, this.offset = 0});
...
class ClubSaleListing {
  ...
  factory ClubSaleListing.fromJson(Object? value) {
    ...
    final String clubId = _clubSaleString(<Object?>[
      json['club_id'],
      json['clubId'],
      club?['id'],
      club?['club_id'],
    ...
    final double askingPrice = _clubSaleNumber(<Object?>[
      json['asking_price'],
      json['askingPrice'],
    ]);
    final double systemValuation = _clubSaleNumber(<Object?>[
      json['system_valuation'],
      json['systemValuation'],
    ], fallback: askingPrice);
    return ClubSaleListing(
      listingId: _clubSaleString(<Object?>[
        json['listing_id'],
        json['listingId'],
        json['id'],
        clubId,
      ...
      clubId: clubId,
      clubName: _clubSaleString(<Object?>[
        json['club_name'],
        json['clubName'],
        club?['name'],
        club?['club_name'],
      ...
      sellerUserId: _clubSaleString(<Object?>[
        json['seller_user_id'],
        json['sellerUserId'],
        json['seller_id'],
        json['sellerId'],
      ...
      visibility: _clubSaleString(<Object?>[
        json['visibility'],
      ], fallback: 'public'),
      currency: _clubSaleString(<Object?>[
        json['currency'],
      ], fallback: 'credits'),
      askingPrice: askingPrice,
      systemValuation: systemValuation,
      systemValuationMinor: _clubSaleInt(<Object?>[
        json['system_valuation_minor'],
        json['systemValuationMinor'],
      ], fallback: systemValuation.round()),
      valuationLastRefreshedAt: _clubSaleDateTime(<Object?>[
        json['valuation_last_refreshed_at'],
        json['valuationLastRefreshedAt'],
      ]),
      createdAt:
          _clubSaleDateTime(<Object?>[json['created_at'], json['createdAt']]) ??
          DateTime.fromMillisecondsSinceEpoch(0, isUtc: true),
      updatedAt:
          _clubSaleDateTime(<Object?>[json['updated_at'], json['updatedAt']]) ??
          DateTime.fromMillisecondsSinceEpoch(0, isUtc: true),
      valuationBreakdown:
          jsonMapOrNull(
      ...
      metadata:
          jsonMapOrNull(json['metadata_json'] ?? json['metadataJson']) ??
          const <String, Object?>{},
    );
  }
}
...
class ClubSaleListingCollection {
  const ClubSaleListingCollection({required this.total, required this.items});
  ...
  factory ClubSaleListingCollection.fromJson(Object? value) {
    ...
    final Object? rawItems = _firstNonNullObject(<Object?>[
      json['items'],
      json['listings'],
      json['results'],
    ]);
...
String _clubSaleString(List<Object?> values, {String fallback = ''}) {
  for (final Object? value in values) {
...
double _clubSaleNumber(List<Object?> values, {double fallback = 0}) {
  for (final Object? value in values) {
    if (value == null) {
      continue;
    }
...
int _clubSaleInt(List<Object?> values, {int fallback = 0}) {
  for (final Object? value in values) {
    if (value == null) {
      continue;
    }
...
class ClubSaleInquiryCollection {
  const ClubSaleInquiryCollection({required this.total, required this.items});
...
class ClubSaleOfferCollection {
  const ClubSaleOfferCollection({required this.total, required this.items});
...
class ClubSaleOwnershipTransition {
  ...
  factory ClubSaleOwnershipTransition.fromJson(Object? value) {
    final JsonMap json = jsonMap(
      value,
      label: 'club sale ownership transition',
    );
...
class ClubSaleTransferExecution {
  ...
  factory ClubSaleTransferExecution.fromJson(Object? value) {
    ...
    return ClubSaleTransferExecution(
      ...
      ownershipTransition:
          jsonMapOrNull(json['ownership_transition']) == null
              ? null
              : ClubSaleOwnershipTransition.fromJson(
                json['ownership_transition'],
              ),
      createdAt:
          dateTimeValue(json['created_at']) ??
          DateTime.fromMillisecondsSinceEpoch(0, isUtc: true),
...
class ClubSaleOwnershipHistoryEvent {
  ...
  factory ClubSaleOwnershipHistoryEvent.fromJson(Object? value) {
    final JsonMap json = jsonMap(
      value,
      label: 'club sale ownership history event',
    );
