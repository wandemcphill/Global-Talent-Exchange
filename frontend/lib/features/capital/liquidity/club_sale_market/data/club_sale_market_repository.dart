...
ClubSaleMarketRepository createClubSaleMarketRepository({
  required String baseUrl,
  required GteBackendMode backendMode,
  required String? accessToken,
}) {
  if (backendMode == GteBackendMode.fixture) {
    return ClubSaleMarketApiRepository.fixture(
      baseUrl: baseUrl,
      accessToken: accessToken,
    );
  }
  return ClubSaleMarketApiRepository.standard(
    baseUrl: baseUrl,
    mode: backendMode,
    accessToken: accessToken,
  );
...
ClubSaleMarketRepository clubSaleMarketRepositoryForClient(
  GteAuthedApi client,
) {
  return ClubSaleMarketApiRepository(client: client);
}
...
class ClubSaleMarketApiRepository implements ClubSaleMarketRepository {
  ...
  factory ClubSaleMarketApiRepository.fixture({
    ...
    String? accessToken = 'fixture-token',
  }) {
    return ClubSaleMarketApiRepository(
      client: createFeatureApi(
        baseUrl: baseUrl,
  ...
  Future<T> _withFallback<T>(
    ...
    if (enableFixtureFallback && _client.mode == GteBackendMode.fixture) {
      return fixture();
    }
    return live();
  }
