...
enum CreatorLeagueAdminView { finance, settlements }
...
class _CreatorLeagueAdminScreenState extends State<CreatorLeagueAdminScreen> {
  ...
  String get _title =>
      widget.initialView == CreatorLeagueAdminView.settlements
          ? 'Creator league settlements'
          : 'Creator league finance';

  String get _heroCopy =>
      widget.initialView == CreatorLeagueAdminView.settlements
  ...
  Future<void> _load() async {
    ...
    await _controller.loadFinance(
      ...
      settlementsQuery: CreatorLeagueFinancialSettlementsQuery(
                          ...
                          children: <Widget>[
                            ...
                            if (report != null)
                              GteMetricChip(
                                label: 'Review queue',
                                value:
                                    report.settlementsRequiringReview.length
                                        .toString(),
                              ),
                          ],
                        ),
