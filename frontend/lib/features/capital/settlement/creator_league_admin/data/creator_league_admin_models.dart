...
class CreatorLeagueConfigUpdateRequest {
  ...
  JsonMap toJson() => compactQuery(<String, Object?>{
    ...
    'settlement_review_total_revenue_coin': settlementReviewTotalRevenueCoin,
    'settlement_review_creator_share_coin': settlementReviewCreatorShareCoin,
    'settlement_review_platform_share_coin': settlementReviewPlatformShareCoin,
...
class CreatorLeagueSeasonTierAssignmentRequest {
  ...
  JsonMap toJson() => <String, Object?>{'tier_id': tierId, 'club_ids': clubIds};
}
...
class CreatorLeagueSeasonCreateRequest {
  ...
  JsonMap toJson() => <String, Object?>{
    ...
    'assignments': assignments
        .map((CreatorLeagueSeasonTierAssignmentRequest item) => item.toJson())
        .toList(growable: false),
  };
}

class CreatorLeagueSettlementReviewRequest {
  const CreatorLeagueSettlementReviewRequest({this.reviewNote});

  final String? reviewNote;

  JsonMap toJson() =>
      compactQuery(<String, Object?>{'review_note': reviewNote});
}

class CreatorLeagueLivePriorityQuery {
  const CreatorLeagueLivePriorityQuery({this.limit = 10});
...
class CreatorLeagueConfig {
  ...
  List<JsonMap> get movementRules => jsonMapList(
    raw['movement_rules'],
...
class CreatorLeagueFinancialReport {
  ...
  List<JsonMap> get recentAuditEvents => jsonMapList(
    raw['recent_audit_events'],
