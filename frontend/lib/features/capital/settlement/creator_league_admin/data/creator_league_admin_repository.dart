...
class CreatorLeagueAdminApiRepository implements CreatorLeagueAdminRepository {
  CreatorLeagueAdminApiRepository({required GteAuthedApi client})
    : _client = client;

  static const String _basePath = '/api/creator-league';
  ...
  Future<CreatorLeagueConfig> createTier(
    ...
    return CreatorLeagueConfig.fromJson(
      await _client.request('POST', '$_basePath/tiers', body: request.toJson()),
    );
  }
  ...
  Future<CreatorLeagueConfig> deleteTier(String tierId) async {
    return CreatorLeagueConfig.fromJson(
      await _client.request('DELETE', '$_basePath/tiers/$tierId'),
    );
  }
