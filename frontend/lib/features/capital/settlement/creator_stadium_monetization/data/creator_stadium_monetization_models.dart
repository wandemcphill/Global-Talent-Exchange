...
class CreatorMatchAccessQuery {
  const CreatorMatchAccessQuery({this.durationMinutes = 90});
...
class CreatorMatchAnalyticsQuery {
  const CreatorMatchAnalyticsQuery({this.clubId});

  final String? clubId;

  Map<String, Object?> toQuery() =>
      compactQuery(<String, Object?>{'club_id': clubId});
}

class CreatorClubStadiumQuery {
  const CreatorClubStadiumQuery({required this.seasonId});
...
class CreatorBroadcastPurchaseRequest {
  const CreatorBroadcastPurchaseRequest({required this.durationMinutes});

  final int durationMinutes;

  JsonMap toJson() => <String, Object?>{'duration_minutes': durationMinutes};
}
...
class CreatorStadiumTicketPurchaseRequest {
  const CreatorStadiumTicketPurchaseRequest({required this.ticketType});

  final String ticketType;

  JsonMap toJson() => <String, Object?>{'ticket_type': ticketType};
}
...
class CreatorStadiumLevelUpdateRequest {
  const CreatorStadiumLevelUpdateRequest({required this.level});
...
class CreatorMatchAccess {
  ...
  factory CreatorMatchAccess.fromJson(Object? value) {
    return CreatorMatchAccess._(jsonMap(value, label: 'creator match access'));
  }
...
class CreatorSeasonPass {
  ...
  factory CreatorSeasonPass.fromJson(Object? value) {
    return CreatorSeasonPass._(jsonMap(value, label: 'creator season pass'));
  }
...
class CreatorMatchGift {
  ...
  factory CreatorMatchGift.fromJson(Object? value) {
    return CreatorMatchGift._(jsonMap(value, label: 'creator match gift'));
  }
