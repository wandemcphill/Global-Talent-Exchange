...
class GteWalletSummaryCard extends StatelessWidget {
  ...
  final CapitalWalletDisplaySnapshot summary;
    ...
    return GteSurfacePanel(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Wrap(
            ...
            children: <Widget>[
              ...
              GteMetricChip(
                ...
                positive: summary.lockedBalance <= 0,
              ),
              GteMetricChip(
                label: 'Pending withdrawal',
                value:
                    summary.pendingWithdrawalBalance == null
                        ? '--'
                        : gteFormatAmountForUnit(
                ...
                positive:
                    summary.pendingWithdrawalBalance == null ||
                    summary.pendingWithdrawalBalance! <= 0,
              ),
              GteMetricChip(
                label: 'Total',
                value: gteFormatAmountForUnit(
          ...
          if (summary.lockReasons.isNotEmpty) ...<Widget>[
            const SizedBox(height: 14),
            Text(
              'Lock reasons: ${summary.lockReasons.join(', ')}',
              style: Theme.of(context).textTheme.bodySmall,
            ),
          ],
        ],
