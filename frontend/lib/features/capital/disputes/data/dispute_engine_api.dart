...
import 'package:gte_frontend/models/dispute_engine_models.dart';
...
class DisputeEngineApi {
  ...
  Future<List<DisputeEngineCase>> listMyDisputes() {
    return _withOptionalFixture<List<DisputeEngineCase>>(() async {
  ...
  Future<DisputeEngineDetail> createDispute({
    ...
    return _withOptionalFixture<DisputeEngineDetail>(() async {
  ...
  Future<DisputeEngineCase> assignDispute({
    ...
    return _withOptionalFixture<DisputeEngineCase>(() async {
      final Object? payload = await client.request(
        'POST',
