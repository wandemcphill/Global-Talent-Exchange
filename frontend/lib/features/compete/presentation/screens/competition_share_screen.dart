...
import 'package:gte_frontend/features/compete/widgets/competition_share_card.dart';
import 'package:gte_frontend/widgets/gte_shell_theme.dart';
import 'package:gte_frontend/widgets/gte_state_panel.dart';

class CompetitionShareScreen extends StatefulWidget {
  const CompetitionShareScreen({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(title: const Text('Share competition')),
        body: AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget? child) {
            ...
            final CompetitionInviteView? invite =
                widget.controller.latestInvite;
            if (competition == null) {
            ...
            return ListView(
              ...
              children: <Widget>[
                CompetitionShareCard(
                  ...
                  message: message,
                  onCopyCode:
                      () => _copy(invite.inviteCode, 'Invite code copied'),
