...
import 'package:gte_frontend/features/compete/widgets/competition_rule_editor.dart';

class CompetitionRuleBuilderScreen extends StatelessWidget {
  const CompetitionRuleBuilderScreen({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Rules builder')),
