      ...
      builder: (BuildContext context, Widget? child) {
        ...
        final int openCount =
            competitions
                ...
                .length;
        final bool hasActiveSeason = competitionHubHasActiveSeason(
          destination,
          competitions,
        );
          ...
          child: ListView(
            ...
            children: <Widget>[
              GtexHeroBanner(
                ...
                description:
                    'Browse leagues, cups, fast cups, and user-created competitions from one backend-synced arena desk built for football tension, not flat listings.',
                ...
                sidePanel: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        'Qualification, backend rounds, key moments, injuries, and bracket status stay in one clear matchday flow.',
                        style: Theme.of(context).textTheme.bodyMedium,
                      ),
                    ],
                  ),
                  ...
                  GtexSignalTile(
                    ...
                    caption:
                        competitions
                            ...
                            : 'No active backend route yet. Published contests become the next live watchlist.',
  ...
  List<Widget> _buildOverview(
    ...
    return <Widget>[
      const _ArenaSectionHeader(
        ...
        title: 'Arena control',
        description:
            'Official competitions, manager-hosted cups, standings, results, and prize pools share one launch surface.',
      ),
      const SizedBox(height: 12),
      GteSurfacePanel(
        child: Column(
                  ...
                  .map(
                    (CompetitionHubDestination value) => SizedBox(
                      ...
                      child: _DestinationRouteCard(
                        destination: value,
                        count:
                            value == CompetitionHubDestination.worldSuperCup
                                ? 0
      ...
      if (liveBoard.isNotEmpty) ...<Widget>[
        const _ArenaSectionHeader(
          ...
          title: 'Live competition desk',
          description:
              'A quick competition strip for the backend states most likely to shape highlights, results, and bracket movement.',
        ),
        const SizedBox(height: 12),
        ...liveBoard.map(
      ...
      if (featured.isEmpty)
        ...
        if (gtexCompetitions.isNotEmpty) ...<Widget>[
          const _ArenaSectionHeader(
            ...
            title: 'Platform-run competitions and promo pools',
            description:
        ...
        Text('Featured now', style: Theme.of(context).textTheme.titleLarge),
        const SizedBox(height: 12),
        ...featured.map(
          (CompetitionSummary item) => Padding(
            padding: const EdgeInsets.only(bottom: 16),
          ...
          children: <Widget>[
            ...
            Wrap(
              ...
              children: <Widget>[
                ...
                GteMetricChip(label: 'Route', value: 'PERSISTENT'),
                GteMetricChip(
                  label: 'Watchlist',
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Material(
            ...
            child: Chip(label: Text(destination.routePath)),
          ),
          const SizedBox(height: 12),
