...
class CompetitionControlRepository {
  ...
  factory CompetitionControlRepository.standard({
  ...
  Future<Map<String, dynamic>> fetchRuntime(
    String code, {
    required int participants,
    String region = 'africa',
  }) => _getMap(
    '/api/competitions/runtime/$code',
    query: <String, Object?>{'participants': participants, 'region': region},
    auth: false,
  );
  Future<List<Map<String, dynamic>>> fetchAdminCompetitions() =>
      _getList('/api/competitions/admin');
  Future<Map<String, dynamic>> updateCompetition(
    String code,
    Map<String, Object?> body,
  ) => _patchMap('/api/competitions/admin/$code', body: body);
  Future<Map<String, dynamic>> fetchOrchestrationPreview(
    String code, {
    int participants = 6,
    String region = 'africa',
  }) => _getMap(
  ...
  Future<Map<String, dynamic>> _getMap(
    ...
    throw const GteApiException(
      ...
      message: 'Unexpected competition response shape.',
    );
  }
  ...
  Future<List<Map<String, dynamic>>> _getList(
    ...
    throw const GteApiException(
      type: GteApiErrorType.parsing,
      message: 'Unexpected competition list response shape.',
    );
  }
