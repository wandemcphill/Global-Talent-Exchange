...
import 'competition_bracket_models.dart';
...
class CompetitionSummary {
  ...
  final bool? broadcastVisible;
  final String? verificationStatus;
  final int? walkoverCount;
  ...
  String get economyNotice {
    switch (matchType) {
      case MatchType.gtexHosted:
        return 'GTEX competitions are free to join. Rewards settle only after verified backend results.';
      case MatchType.userHosted:
  ...
  factory CompetitionSummary.fromJson(Object? value) {
    ...
    return CompetitionSummary(
      ...
      lifecycle: _lifecycleOrNullFrom(
        _firstValue(
          <Map<String, Object?>>[json],
          <String>['lifecycle', 'lifecycle_state', 'lifecycleState'],
        ),
      ),
      scoreVisible: _boolOrNullFrom(
        <Map<String, Object?>>[json],
        <String>[
          'score_visible',
          'scoreVisible',
      ...
      broadcastVisible: _boolOrNullFrom(
        <Map<String, Object?>>[json],
        <String>[
          'broadcast_visible',
          'broadcastVisible',
      ...
      verificationStatus: _stringOrNullFrom(
        <Map<String, Object?>>[json],
        <String>[
          'verification_status',
          'verificationStatus',
      ...
      walkoverCount: _intOrNullFrom(
        <Map<String, Object?>>[json],
        <String>['walkover_count', 'walkoverCount', 'walkovers'],
      ),
      forfeitCount: _intOrNullFrom(
        <Map<String, Object?>>[json],
        <String>['forfeit_count', 'forfeitCount', 'forfeits'],
      ),
  ...
  CompetitionSummary copyWith({
    ...
    CompetitionLifecycleState? lifecycle,
    bool? scoreVisible,
    bool? broadcastVisible,
    ...
    return CompetitionSummary(
      ...
      broadcastVisible: broadcastVisible ?? this.broadcastVisible,
      verificationStatus: verificationStatus ?? this.verificationStatus,
      walkoverCount: walkoverCount ?? this.walkoverCount,
      forfeitCount: forfeitCount ?? this.forfeitCount,
...
CompetitionLifecycleState? _lifecycleOrNullFrom(Object? value) {
  if (value == null) {
    return null;
  }
  try {
    return CompetitionLifecycleState.fromJson(value);
  } on GteParsingException {
    return null;
  }
}

int? _intOrNullFrom(Iterable<Map<String, Object?>> sources, List<String> keys) {
  final Object? value = _firstValue(sources, keys);
  if (value == null) {
    return null;
  }
