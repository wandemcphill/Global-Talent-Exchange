...
class GtexProfileController {
  const GtexProfileController();

  Future<GtexProfileSummary> loadProfile() async {
    // Codex: replace this demo fallback with the existing authenticated user/session/profile repository.
    return GtexProfileSummary.demo();
  }
  ...
  List<GtexSettingSection> settingSections() => const [
        GtexSettingSection(
          ...
          items: [
            ...
            GtexSettingItem(
              id: 'club_identity',
              title: 'Club identity',
              description: 'Linked club, public owner identity, and club owner status.',
              status: 'Active',
            ),
          ],
        ),
        GtexSettingSection(
          id: 'security',
          title: 'Security',
          subtitle: 'Protect access to wallets, clubs, orders, and admin workflows.',
          items: [
            GtexSettingItem(
              id: 'password',
        ...
        GtexSettingSection(
          id: 'preferences',
          title: 'Preferences',
          subtitle: 'Control notifications, news, market alerts, and display defaults.',
          items: [
            GtexSettingItem(
              id: 'notifications',
              title: 'Notification preferences',
              description: 'Choose alerts for market, club, wallet, news, and competitions.',
              status: 'Custom',
            ),
            GtexSettingItem(
              id: 'news',
  ...
  List<GtexSystemStateSpec> systemStateGallery() => const [
        ...
        GtexSystemStateSpec(
          ...
          message: 'Once activity starts, this space will become your GTEX command view.',
        ...
        GtexSystemStateSpec(
          ...
          message: 'GTEX needs a stable connection for market, wallet, and match data.',
        ...
        GtexSystemStateSpec(
          ...
          message: 'This area is temporarily paused while GTEX operations complete checks.',
