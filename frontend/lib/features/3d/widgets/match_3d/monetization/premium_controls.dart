...
class PremiumControls extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final RenderMode canonicalSelected =
      ...
      return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              'Paid legacy controls are quarantined. The backend-authoritative 2D broadcast match center is active.',
            ...
            children: <Widget>[
              ...
              FittedBox(
                ...
                child: SegmentedButton<RenderMode>(
                  ...
                  selected: <RenderMode>{canonicalSelected},
              ...
              const SizedBox(height: 8),
              Text(
                'Lane render: 2D tactical | Wallet ${availableCoins.toStringAsFixed(2)} coin',
                softWrap: true,
