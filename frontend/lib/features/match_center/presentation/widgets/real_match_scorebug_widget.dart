...
class RealMatchScorebugWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String displayClockLabel = scoreMasked ? '--:--' : clockLabel;
    final String homeScoreLabel = scoreMasked ? '--' : '$homeScore';
    final String awayScoreLabel = scoreMasked ? '--' : '$awayScore';
