...
class ScoreboardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String homeScoreLabel =
        viewState.scoreRevealLocked ? '--' : '${frame.homeScore}';
    final String awayScoreLabel =
        viewState.scoreRevealLocked ? '--' : '${frame.awayScore}';
    final String clockLabel =
        viewState.scoreRevealLocked ? '--:--' : "${frame.clockMinute.floor()}'";
    final String periodLabel =
        viewState.scoreRevealLocked ? '--' : _periodLabel(frame);
    return Container(
