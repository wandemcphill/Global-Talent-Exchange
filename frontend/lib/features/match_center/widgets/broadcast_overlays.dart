...
class BroadcastScoreboardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String displayClockLabel = _clockLabel(
      masked: scoreMasked,
      homeScore: homeScore,
      awayScore: awayScore,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          ...
          colors: <Color>[Color(0xF00A1828), Color(0xE0122033)],
        ),
      ...
      child: Wrap(
        ...
        children: <Widget>[
          ...
          _TeamCluster(
            ...
            scoreLabel: _scoreLabel(masked: scoreMasked, score: homeScore),
            alignEnd: false,
          ),
          Text(
            ':',
          ...
          _TeamCluster(
            ...
            scoreLabel: _scoreLabel(masked: scoreMasked, score: awayScore),
            alignEnd: true,
          ),
          Container(
            width: 1,
...
String _scoreLabel({required bool masked, required int? score}) {
...
String _clockLabel({
  ...
  if (masked || homeScore == null || awayScore == null) {
    return '--:--';
  }
  return clockLabel;
}
...
class BroadcastStartingBanner extends StatelessWidget {
  const BroadcastStartingBanner({super.key, required this.opacity});
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
              ...
              colors: <Color>[Color(0xF0101E31), Color(0xE0192740)],
            ),
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
              ...
              colors: <Color>[Color(0xF0101E31), Color(0xE0162438)],
            ),
            border: Border.all(color: Colors.white.withValues(alpha: 0.14)),
            boxShadow: <BoxShadow>[
              BoxShadow(
...
class BroadcastStadiumFade extends StatelessWidget {
  const BroadcastStadiumFade({super.key, required this.opacity});
...
String _lineupPlayerLabel(dynamic player) {
  ...
  final String label =
      (player.label as String?)?.trim().isNotEmpty == true
...
class _TeamCluster extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget name = Text(
      ...
      style: Theme.of(
        context,
      ).textTheme.labelLarge?.copyWith(color: Colors.white, letterSpacing: 1),
    );
