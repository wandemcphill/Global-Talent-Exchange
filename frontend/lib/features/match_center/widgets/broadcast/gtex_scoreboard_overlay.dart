...
class GtexScoreboardOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String clockLabel = _clockLabel(hudState);
    return Align(
            ...
            children: <Widget>[
              _TeamCell(
                ...
                scoreLabel: _scoreLabel(
                  masked: hudState.scoreMasked,
                  score: hudState.homeScore,
                ),
                alignEnd: false,
                compact: compact,
              ),
...
String _clockLabel(GtexBroadcastHudState hudState) {
  if (hudState.scoreMasked ||
      hudState.homeScore == null ||
      hudState.awayScore == null) {
    return '--:--';
  }
  return hudState.clockLabel;
}
