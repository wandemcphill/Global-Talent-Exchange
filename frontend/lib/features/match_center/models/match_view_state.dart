...
enum MatchMode { quick, standard, cinematic }
...
enum MatchVerificationStatus { verified, unverified, tampered }
...
class MatchViewerTeam {
  ...
  MatchViewerTeam copyWith({String? teamName, String? shortName}) {
  ...
  factory MatchViewerTeam.fromJson(Object? value) {
    ...
    return MatchViewerTeam(
      ...
      primaryColorHex: GteJson.string(json, <String>[
        'primary_color',
        'primaryColor',
      ]),
      secondaryColorHex: GteJson.string(json, <String>[
        'secondary_color',
        'secondaryColor',
      ]),
      accentColorHex: GteJson.string(json, <String>[
        'accent_color',
        'accentColor',
      ]),
      goalkeeperColorHex: GteJson.string(json, <String>[
        'goalkeeper_color',
        'goalkeeperColor',
      ]),
    );
...
class MatchFairnessIndicator {
  const MatchFairnessIndicator({
    ...
    this.visualOnlyEngagement = true,
  ...
  final bool visualOnlyEngagement;
  ...
  bool get visualOnlyMonetization => visualOnlyEngagement;
  ...
  factory MatchFairnessIndicator.fromJson(Object? value) {
    ...
    return MatchFairnessIndicator(
      ...
      label: GteJson.string(json, <String>[
        'label',
      ], fallback: 'Fair Play Pending'),
      message: GteJson.stringOrNull(json, <String>['message']),
      noPayToWin: GteJson.boolean(json, <String>[
        'no_pay_to_win',
        'noPayToWin',
      ], fallback: true),
      visualOnlyEngagement: GteJson.boolean(json, <String>[
        'visual_only_engagement',
        'visualOnlyEngagement',
      ], fallback: true),
      serverAuthoritative: GteJson.boolean(json, <String>[
        'server_authoritative',
        'serverAuthoritative',
      ], fallback: true),
      tournamentFairnessMode: GteJson.stringOrNull(json, <String>[
        'tournament_fairness_mode',
        'tournamentFairnessMode',
      ]),
      homeSpendTier: GteJson.stringOrNull(json, <String>[
        'home_spend_tier',
        'homeSpendTier',
      ]),
      awaySpendTier: GteJson.stringOrNull(json, <String>[
        'away_spend_tier',
        'awaySpendTier',
      ]),
      squadBalancePolicy: GteJson.stringOrNull(json, <String>[
        'squad_balance_policy',
        'squadBalancePolicy',
      ]),
      softBalanceApplied: GteJson.boolean(json, <String>[
        'soft_balance_applied',
        'softBalanceApplied',
      ], fallback: false),
    );
  }
...
class MatchTimelineProof {
  ...
  factory MatchTimelineProof.fromJson(Object? value) {
    ...
    return MatchTimelineProof(
      ...
      matchHash: GteJson.string(json, <String>[
        'match_hash',
        'matchHash',
      ], fallback: ''),
      timelineHash: GteJson.string(json, <String>[
        'timeline_hash',
        'timelineHash',
      ], fallback: ''),
      visibleTimelineHash: GteJson.string(json, <String>[
        'visible_timeline_hash',
        'visibleTimelineHash',
      ], fallback: ''),
      signed: GteJson.boolean(json, <String>['signed'], fallback: true),
      revealedThroughSeconds: GteJson.integer(json, <String>[
        'revealed_through_seconds',
        'revealedThroughSeconds',
      ], fallback: 0),
    );
  }
}
...
class MatchViewState {
  const MatchViewState({
    ...
    this.engagement = const MatchViewerEngagement(),
  ...
  factory MatchViewState.fromJson(Object? value) {
    ...
    return MatchViewState(
      ...
      supportsOffside: GteJson.boolean(json, <String>[
        'supports_offside',
        'supportsOffside',
      ], fallback: false),
      deterministicSeed: GteJson.integerOrNull(json, <String>[
        'deterministic_seed',
        'deterministicSeed',
      ]),
      ...
      durationSeconds: GteJson.integer(json, <String>[
        'duration_seconds',
        'durationSeconds',
      ...
      scoreRevealLocked: GteJson.boolean(json, <String>[
        'score_reveal_locked',
        'scoreRevealLocked',
      ], fallback: false),
      segmentStartSeconds: GteJson.integer(json, <String>[
        'segment_start_seconds',
        'segmentStartSeconds',
      ], fallback: 0),
      segmentEndSeconds: GteJson.integer(json, <String>[
        'segment_end_seconds',
        'segmentEndSeconds',
      ], fallback: frames.isEmpty ? 0 : frames.last.timeSeconds.ceil()),
      hasMoreSegments: GteJson.boolean(json, <String>[
        'has_more_segments',
        'hasMoreSegments',
      ], fallback: false),
      nextSegmentToken: GteJson.stringOrNull(json, <String>[
        'next_segment_token',
        'nextSegmentToken',
      ]),
      engagement: MatchViewerEngagement.fromJson(
        GteJson.value(json, <String>['engagement']),
      ),
      presentationPackage:
          GteJson.value(json, <String>[
  ...
  MatchViewState copyWith({
    ...
    MatchViewerEngagement? engagement,
