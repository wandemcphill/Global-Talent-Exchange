              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  _LeaderboardCard(
                    ...
                    entries:
                        _controller.matchLeaderboard?.entries ??
                  ...
                  _LeaderboardCard(
                    ...
                    entries:
                        _controller.weeklyLeaderboard?.entries ??
                        const <Map<String, Object?>>[],
                  ),
                  const SizedBox(height: 18),
                  GteSurfacePanel(
...
class _LeaderboardCard extends StatelessWidget {
  const _LeaderboardCard({required this.title, required this.entries});
