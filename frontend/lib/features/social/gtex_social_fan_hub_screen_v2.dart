...
class GtexSocialFanHubScreenV2 extends StatefulWidget {
  const GtexSocialFanHubScreenV2({super.key});

  @override
  State<GtexSocialFanHubScreenV2> createState() => _GtexSocialFanHubScreenV2State();
}
        ...
        body: SafeArea(
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              return Row(
                children: [
                  if (isWide) SizedBox(width: 320, child: _SocialLeftPanel(controller: controller)),
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Text('GTEX Fan Hub', style: TextStyle(color: Colors.white, fontSize: 34, fontWeight: FontWeight.w900)),
                          const SizedBox(height: 6),
                          const Text('Follow clubs, react to AI football stories, join fan wars, track shares, and invite new managers.', style: TextStyle(color: gtexCreatorTextSoft)),
                          const SizedBox(height: 18),
                          GtexSocialFeedPanel(
                            stories: controller.stories,
                            followedClubs: controller.snapshot.followedClubs,
...
class _SocialLeftPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: const Color(0xFF090F19), border: Border(right: BorderSide(color: Colors.white.withOpacity(.07)))),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Community', style: TextStyle(color: Colors.white, fontSize: 25, fontWeight: FontWeight.w900)),
          ...
          ...GtexSocialModule.values.map((module) {
            ...
            return Padding(
              ...
              child: ListTile(
                ...
                trailing: Icon(Icons.chevron_right_rounded, color: selected ? gtexCreatorGreen : Colors.white38),
              ),
            );
          }),
        ],
