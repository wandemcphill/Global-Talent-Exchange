        ...
        children: <Widget>[
          GteSurfacePanel(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text('Market hub', style: Theme.of(context).textTheme.headlineSmall),
                ...
                Wrap(
                  ...
                  children: <Widget>[
                    FilledButton.tonalIcon(
                      onPressed: controller.isRefreshingMarket ? null : () {
          ...
          if (pulse != null)
            GteSurfacePanel(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text('Live ticker', style: Theme.of(context).textTheme.titleLarge),
            ...
            ...players.map(
              (PlayerSnapshot player) => Padding(
                ...
                child: ListTile(
                  ...
                  subtitle: Text('${player.club} - GSI ${player.gsi} - ${player.marketCredits} cr'),
  ...
  Widget build(BuildContext context) {
    return GteSurfacePanel(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Text('Transfer room preview', style: Theme.of(context).textTheme.headlineSmall),
          const SizedBox(height: 16),
          if (pulse == null)
            Text('Market feed unavailable.', style: Theme.of(context).textTheme.bodyMedium)
          else
              ...
              (TransferRoomEntry entry) => Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    const SizedBox(height: 8),
                    Text(entry.headline, style: Theme.of(context).textTheme.titleLarge),
