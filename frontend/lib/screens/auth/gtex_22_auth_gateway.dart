      ...
      body: SafeArea(
        child: Center(
          child: SingleChildScrollView(
            padding: EdgeInsets.all(narrow ? 20 : 42),
            child: ConstrainedBox(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                ...
                LayoutBuilder(builder: (_, c) {
                  ...
                  return GridView.builder(shrinkWrap: true, physics: const NeverScrollableScrollPhysics(), itemCount: roles.length, gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: columns, crossAxisSpacing: 14, mainAxisSpacing: 14, childAspectRatio: columns == 1 ? 2.5 : 1.2), itemBuilder: (_, i) => _RoleCard(role: roles[i]));
                }),
...
class _Role {
  const _Role(this.title, this.body, this.icon, this.accent, this.route);
  final String title, body, route; final IconData icon; final Color accent;
}
...
class Gtex22LoginScreen extends StatefulWidget {
  ...
  @override
  State<Gtex22LoginScreen> createState() => _Gtex22LoginScreenState();
}
...
class _Gtex22LoginScreenState extends State<Gtex22LoginScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (mounted && widget.controller.isAuthenticated) context.go('/app/home');
    } catch (e) {
