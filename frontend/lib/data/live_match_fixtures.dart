...
class LiveMatchLineupPlayer {
  ...
  String stablePlayerReference({
    ...
    final String? canonicalSeed = _normalizeIdentityText(avatarSeedToken) ??
...
List<LiveMatchLineupPlayer>? _lineupFromPayload(Object? value) {
  ...
  return value.map((Object? item) {
    ...
    return LiveMatchLineupPlayer(
      ...
      dominantFoot: GteJson.stringOrNull(
        json,
        <String>[
          'dominant_foot',
          'dominantFoot',
      ...
      roleArchetype: GteJson.stringOrNull(
        json,
        <String>['role_archetype', 'roleArchetype', 'archetype'],
      ),
      ...
      squadEligible:
          GteJson.value(json, <String>['squad_eligible', 'squadEligible']) ==
                  null
              ? null
              : GteJson.boolean(
                  json,
                  <String>['squad_eligible', 'squadEligible'],
                ),
