class MatchResponseDto {
  ...
  factory MatchResponseDto.fromJson(Map<String, dynamic> json) {
    final List<MatchItemDto> matches = _asList(json['matches'])
        .map(MatchItemDto.fromJson)
        .toList(growable: false);
    final Map<String, dynamic> metaJson = _asMapOrNull(json['meta']) ??
...
class ReasonDto {
  ...
  factory ReasonDto.fromJson(Object? value) {
    ...
    final Map<String, dynamic> json = _asMap(value);
    final String label = _asString(json['label']) ??
