        ...
        child: Stack(
          children: <Widget>[
            ...
            Positioned(
              ...
              child: _GlowOrb(
                size: 168,
                color: tokens.accentWarm.withValues(alpha: 0.12),
              ),
            ),
            Positioned.fill(
              child: Padding(
                ...
                child: LayoutBuilder(
                  builder: (BuildContext context, BoxConstraints constraints) {
                    ...
                    final Widget right = sidePanel ??
                        _DefaultSignalPanel(accent: resolvedAccent);
                    if (stacked) {
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
...
class GtexSectionBadge extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final Color resolvedColor = color ?? GteShellTheme.tokensOf(context).accent;
    return Container(
