...
class GteOrderDetailCard extends StatelessWidget {
  const GteOrderDetailCard({
    ...
    // Kept temporarily for source compatibility with legacy controller
    // callers. The admin-buyback surface is intentionally no longer rendered.
  ...
  /// Deprecated compatibility inputs. Admin buyback is retired and no longer
  /// appears in the player-share product surface.
