...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("metadata_json", sa.JSON(), nullable=False, server_default=sa.text("'{}'")),
        sa.ForeignKeyConstraint(["primary_profile_id"], ["commentator_profiles.id"], name="fk_cps_primary_profile_id_cprofiles", ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["secondary_profile_id"], ["commentator_profiles.id"], name="fk_cps_secondary_profile_id_cprofiles", ondelete="SET NULL"),
    ...
    op.create_table(
        ...
        sa.Column("metadata_json", sa.JSON(), nullable=False, server_default=sa.text("'{}'")),
        sa.ForeignKeyConstraint(["active_proposal_id"], ["governance_proposals.id"], name="fk_cgs_active_prop_id_gov_props", ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["club_id"], ["club_profiles.id"], name="fk_club_governance_states_club_id_club_profiles", ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["last_executed_proposal_id"], ["governance_proposals.id"], name="fk_cgs_last_exec_prop_id_gov_props", ondelete="SET NULL"),
