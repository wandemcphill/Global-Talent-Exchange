...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("ad_placement_enabled", sa.Boolean(), server_default=sa.text("1"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("live_video_access_enabled", sa.Boolean(), server_default=sa.text("1"), nullable=False),
        sa.Column("stadium_visual_upgrades_enabled", sa.Boolean(), server_default=sa.text("1"), nullable=False),
        sa.Column("custom_chants_enabled", sa.Boolean(), server_default=sa.text("1"), nullable=False),
        sa.Column("custom_visuals_enabled", sa.Boolean(), server_default=sa.text("1"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("includes_live_video_access", sa.Boolean(), server_default=sa.text("1"), nullable=False),
        sa.Column("includes_premium_seating", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        sa.Column("includes_stadium_visual_upgrades", sa.Boolean(), server_default=sa.text("1"), nullable=False),
        sa.Column("includes_custom_chants", sa.Boolean(), server_default=sa.text("1"), nullable=False),
        sa.Column("includes_custom_visuals", sa.Boolean(), server_default=sa.text("1"), nullable=False),
        sa.Column("metadata_json", sa.JSON(), nullable=False),
