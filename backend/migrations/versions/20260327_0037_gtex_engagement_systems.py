...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("transfers_blocked", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("forced_sale_required", sa.Boolean(), nullable=False, server_default=sa.text("false")),
