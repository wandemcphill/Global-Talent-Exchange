...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("is_non_tradable", sa.Boolean(), nullable=False, server_default=sa.text("true")),
    ...
    op.create_table(
        ...
        sa.Column("category_enabled", sa.Boolean(), nullable=False, server_default=sa.text("true")),
