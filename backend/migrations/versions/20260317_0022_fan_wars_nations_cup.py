...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("allow_admin_override", sa.Boolean(), server_default=sa.text("false"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("advanced_to_knockout", sa.Boolean(), server_default=sa.text("false"), nullable=False),
