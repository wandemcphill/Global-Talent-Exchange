...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("allow_creator_club_segmentation", sa.Boolean(), nullable=False, server_default=sa.text("true")),
    ...
    op.create_table(
        ...
        sa.Column("perfect_card", sa.Boolean(), nullable=False, server_default=sa.text("false")),
