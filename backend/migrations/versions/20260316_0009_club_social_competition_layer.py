...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("regional_derby", sa.Boolean(), server_default=sa.text("false"), nullable=False),
        sa.Column("giant_killer_flag", sa.Boolean(), server_default=sa.text("false"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("upset_flag", sa.Boolean(), server_default=sa.text("false"), nullable=False),
        sa.Column("final_flag", sa.Boolean(), server_default=sa.text("false"), nullable=False),
        sa.Column("challenge_match_flag", sa.Boolean(), server_default=sa.text("false"), nullable=False),
        sa.Column("high_view_flag", sa.Boolean(), server_default=sa.text("false"), nullable=False),
        sa.Column("high_gift_flag", sa.Boolean(), server_default=sa.text("false"), nullable=False),
