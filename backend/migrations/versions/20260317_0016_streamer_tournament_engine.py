...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("requires_admin_approval", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        sa.Column("high_reward_flag", sa.Boolean(), server_default=sa.text("0"), nullable=False),
