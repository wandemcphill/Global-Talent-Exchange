...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("CURRENT_TIMESTAMP")),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("CURRENT_TIMESTAMP")),
        sa.ForeignKeyConstraint(["policy_document_version_id"], ["policy_document_versions.id"], name="fk_policy_acceptance_version", ondelete="CASCADE"),
    ...
    op.create_table(
        ...
        sa.Column("deposits_enabled", sa.Boolean(), nullable=False, server_default=sa.text("true")),
        sa.Column("market_trading_enabled", sa.Boolean(), nullable=False, server_default=sa.text("true")),
        sa.Column("platform_reward_withdrawals_enabled", sa.Boolean(), nullable=False, server_default=sa.text("true")),
        sa.Column("user_hosted_gift_withdrawals_enabled", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("gtex_competition_gift_withdrawals_enabled", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("national_reward_withdrawals_enabled", sa.Boolean(), nullable=False, server_default=sa.text("false")),
