...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("immediate_withdrawal_eligible", sa.Boolean(), server_default=sa.text("true"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("fee_credits", sa.String(length=64), nullable=False),
        sa.Column("seller_net_credits", sa.String(length=64), nullable=False),
        sa.Column("eligible_immediately", sa.Boolean(), server_default=sa.text("true"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("allow_fallback_fill", sa.Boolean(), server_default=sa.text("false"), nullable=False),
