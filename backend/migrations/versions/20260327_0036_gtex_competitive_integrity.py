...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("is_user_online_home", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("is_user_online_away", sa.Boolean(), nullable=False, server_default=sa.text("false")),
