...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("platform_share_coin", sa.Numeric(18, 4), nullable=False),
        sa.Column("includes_full_season", sa.Boolean(), server_default=sa.text("true"), nullable=False),
        sa.Column("includes_home_away", sa.Boolean(), server_default=sa.text("true"), nullable=False),
        sa.Column("includes_live_highlights", sa.Boolean(), server_default=sa.text("true"), nullable=False),
        sa.Column("metadata_json", sa.JSON(), nullable=False),
