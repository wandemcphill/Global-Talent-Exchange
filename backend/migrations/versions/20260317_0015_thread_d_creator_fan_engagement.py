...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("shareholder", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        sa.Column("season_pass_holder", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        sa.Column("paying_viewer", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        sa.Column("metadata_json", sa.JSON(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("is_official", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        sa.Column("metadata_json", sa.JSON(), nullable=False),
        sa.ForeignKeyConstraint(["club_id"], ["club_profiles.id"], ondelete="CASCADE"),
