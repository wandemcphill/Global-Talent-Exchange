...
INDEX_SPECS: tuple[tuple[str, str, list[str]], ...] = (
    ...
    (
        ...
        "ix_creator_rivalry_signal_outputs_club_social_rivalry_id",
        ["club_social_rivalry_id"],
    ),
    ...
    (
        ...
        "ix_creator_fan_competition_entries_fan_competition_id",
        ["fan_competition_id"],
    ),
    ...
    (
        ...
        "ix_fan_prediction_outcomes_first_goal_scorer_player_id",
    ...
    (
        ...
        "ix_fan_prediction_submissions_first_goal_scorer_player_id",
        ["first_goal_scorer_player_id"],
    ),
