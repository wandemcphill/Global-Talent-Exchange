...
def test_mapping_service_resolves_existing_country_competition_and_club_by_name(
...
def test_mapping_service_records_unresolved_references_and_increments_occurrence_count(
    gtex_db_session_factory,
) -> None:
    session_factory = gtex_db_session_factory
    service = RealPlayerCanonicalMappingService(settings=_settings())
...
def test_mapping_service_can_auto_create_missing_entities_when_enabled(
    gtex_db_session_factory,
) -> None:
    session_factory = gtex_db_session_factory
...
def test_mapping_service_does_not_auto_create_club_without_safe_competition_context(
    gtex_db_session_factory,
) -> None:
    session_factory = gtex_db_session_factory
    service = RealPlayerCanonicalMappingService(settings=_settings(auto_create=True))
...
def test_mapping_service_reuses_inactive_reference_mapping(
    gtex_db_session_factory,
) -> None:
    session_factory = gtex_db_session_factory
    service = RealPlayerCanonicalMappingService(settings=_settings())
