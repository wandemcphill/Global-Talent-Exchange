...
def test_persistence_migrations_create_expected_tables(tmp_path) -> None:
    ...
    assert inspector.has_table("player_share_markets")
    assert inspector.has_table("player_share_events")
    assert inspector.has_table("leaderboard_seasons")
    assert inspector.has_table("leaderboard_player_ratings")
    assert inspector.has_table("leaderboard_match_results")
    assert inspector.has_table("leaderboard_season_snapshots")
    assert inspector.has_table("leaderboard_season_rewards")
    assert inspector.has_table("national_regen_seeds")
