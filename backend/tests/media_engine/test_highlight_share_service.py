...
def test_highlight_share_export_generates_metadata_manifest(tmp_path: Path, gtex_db_session) -> None:
...
def test_highlight_share_export_package_contains_manifest_and_clip(tmp_path: Path, gtex_db_session) -> None:
    session = gtex_db_session
...
def test_highlight_share_amplification_publishes_story_and_lists_history(tmp_path: Path, gtex_db_session) -> None:
    session = gtex_db_session
