...
def test_creator_clip_revenue_attribution_credits_wallets_and_is_idempotent(gtex_db_session) -> None:
...
def test_creator_clip_revenue_attribution_blocks_shadow_banned_creators(gtex_db_session) -> None:
    session = gtex_db_session
...
def test_creator_clip_revenue_attribution_rejects_low_clip_trust_payout(gtex_db_session) -> None:
    session = gtex_db_session
