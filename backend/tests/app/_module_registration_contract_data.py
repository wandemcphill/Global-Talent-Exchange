...
CREATOR_MEDIA_OPENAPI_ABSENT_PATHS = [
    ...
    "/api/v2/creator/me/summary",
    "/api/creator/me/finance",
    "/api/v2/creator/me/finance",
    "/api/creators/apply",
    "/api/v2/creators/apply",
    "/api/creators/application",
    "/api/v2/creators/application",
    "/api/creators/verify-email",
    "/api/v2/creators/verify-email",
    "/api/creators/verify-phone",
    "/api/v2/creators/verify-phone",
    "/api/creators/clubs/{club_id}/fan-share-market",
    "/api/v2/creators/clubs/{club_id}/fan-share-market",
    "/api/creators/me/clip-earnings",
    "/api/v2/creators/me/clip-earnings",
    "/api/creator/me/clip-earnings",
    "/api/v2/creator/me/clip-earnings",
]
...
MOUNTED_MODULE_ROUTE_CASES = [
    ...
    ("POST", "/matches/start", {}, None, 401),
    ("POST", "/matches/complete", {}, None, 401),
    ...
    ("POST", "/ultimate-league/tournaments", {}, None, 401),
    ...
    ("GET", "/api/v2/calendar-engine/dashboard", None, None, 200),
    ("GET", "/calendar-engine/dashboard", None, None, 404),
    ("GET", "/api/events/today", None, None, 200),
    ("GET", "/api/v2/events/today", None, None, 200),
    ...
    ("GET", "/api/v2/national-team-engine/competitions", None, None, 200),
...
REWARD_AND_INTEGRITY_ROUTE_CASES = [
    ...
    ("POST", "/api/v2/admin/reward-engine/promo-pool/credits", VALID_PROMO_POOL_CREDIT_PAYLOAD, 401),
    ("POST", "/admin/reward-engine/promo-pool/credits", {}, 404),
    ("GET", "/api/integrity-engine/me/score", None, 401),
    ("GET", "/api/v2/integrity-engine/me/score", None, 401),
    ("GET", "/integrity-engine/me/score", None, 404),
    ("POST", "/api/admin/integrity-engine/scan", VALID_INTEGRITY_SCAN_PAYLOAD, 401),
    ("POST", "/api/v2/admin/integrity-engine/scan", VALID_INTEGRITY_SCAN_PAYLOAD, 401),
...
CREATOR_AND_MEDIA_ROUTE_CASES = [
    ...
    ("GET", "/api/v2/creator/profile/me", None, 404),
    ("GET", "/api/creator/me/summary", None, 404),
    ("GET", "/api/v2/creator/me/summary", None, 404),
    ("GET", "/api/creator/me/finance", None, 404),
    ("GET", "/api/v2/creator/me/finance", None, 404),
    ("POST", "/api/creator/verify-email", None, 401),
    ("POST", "/api/v2/creator/verify-email", None, 401),
    ("POST", "/api/creators/apply", {}, 405),
    ("POST", "/api/v2/creators/apply", {}, 405),
    ("GET", "/api/creator/clubs/club-1/fan-share-market/holding", None, 401),
    ("GET", "/api/v2/creator/clubs/club-1/fan-share-market/holding", None, 401),
    ("GET", "/api/creators/clubs/club-1/fan-share-market/holding", None, 404),
    ("GET", "/api/v2/creators/clubs/club-1/fan-share-market/holding", None, 404),
    ("GET", "/api/v2/media-engine/me/clip-earnings", None, 401),
    ("GET", "/api/v2/media-engine/creator-league/season-passes/me", None, 401),
    ("GET", "/api/v2/admin/media-engine/creator-league/stadium-controls", None, 401),
    ("GET", "/api/creators/me/clip-earnings", None, 404),
    ("GET", "/api/v2/creators/me/clip-earnings", None, 404),
]
