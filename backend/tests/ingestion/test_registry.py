...
from app.providers import ApiSportsAdapter, FootballDataAdapter, MockFootballProvider, ProviderRegistry


def test_provider_registry_creates_known_providers() -> None:
    registry = ProviderRegistry()

    assert registry.list_provider_names() == ["api_sports", "football_data", "mock"]
