...
def test_gtex_full_user_journey(client, app_session_factory, auth_user_factory, bootstrap_admin_headers):
    ...
    _ok(client.post(f"/api/transfer-hub/offers/{counter['id']}/accept", headers=club_buyer["headers"]))
    negotiation = _ok(
    ...
    accepted_bid = _ok(
        client.post(
            ...
            headers=club_buyer["headers"],
            json={
                "contract_ends_on": "2029-09-14",
                "contract_starts_on": "2026-09-15",
                "wage_amount": "175",
            },
        )
    )
    ...
    user_gift = _ok(
        client.post(
            ...
            json={
                ...
                "idempotency_key": f"{PREFIX}-user-gift",
            },
        ),
        201,
    )
    ...
    club_gift = _ok(
        client.post(
            ...
            json={
                ...
                "idempotency_key": f"{PREFIX}-club-gift",
            },
        ),
        201,
    )
