...
class AdminRewardRuleStabilityControls(BaseModel):
    ...
    gtex_competition_gift: AdminGiftStabilityControlConfig = Field(
        default_factory=_default_gtex_competition_gift_controls
    )
    creator_match_gift: AdminGiftStabilityControlConfig = Field(default_factory=_default_creator_match_gift_controls)
    creator_viewer_purchase: AdminRewardLoopControlConfig = Field(
        default_factory=_default_creator_viewer_purchase_controls
    )
