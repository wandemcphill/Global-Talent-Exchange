...
from backend.app.club_sale_market.router import router as club_sale_market_router
...
from backend.app.club_identity.trophies.router import router as trophies_router
