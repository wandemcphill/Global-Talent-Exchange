...
from app.routes.player_lifecycle_authorization import authorize_player_lifecycle_mutation
...
router.dependencies.append(Depends(authorize_player_lifecycle_mutation))
