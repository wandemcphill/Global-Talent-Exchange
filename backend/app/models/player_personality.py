...
class PlayerPersonality(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    aggression: Mapped[int] = mapped_column(nullable=False, default=50, server_default="50")
    confidence: Mapped[int] = mapped_column(nullable=False, default=50, server_default="50")
    consistency: Mapped[int] = mapped_column(nullable=False, default=50, server_default="50")
    clutch_factor: Mapped[int] = mapped_column(nullable=False, default=50, server_default="50")
