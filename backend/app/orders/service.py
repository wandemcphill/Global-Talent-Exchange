...
from app.orders.admin_buyback import AdminBuybackError, AdminBuybackExecution, AdminBuybackService
from app.orders.models import Order, OrderSide, OrderStatus
from app.risk.service import RiskControlService, RiskValidationError, TradeSide
...
class OrderService:
    ...
    def _settle_execution(self, session: Session, *, execution: TradeExecution) -> None:
        ...
        reserved_cash = self.wallet_service.get_reserved_cash_balance(session, buyer, unit=buy_order.currency)
